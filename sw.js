const CACHE = 'offcourse-v1.0.0';
const CORE = ['./','./index.html','./styles.css','./app.js','./db.js','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
...
self.addEventListener('fetch', e => {
  ...
  // Runtime-cache map/library assets when available; fail quietly when offline.
