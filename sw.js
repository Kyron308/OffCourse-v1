const CACHE = 'offcourse-v2.0.0';
const CORE = ['./','./index.html','./styles.css','./v2.css','./app.js','./db.js','./manifest.webmanifest','./icon.svg','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
